...
func New(c *common.Common) http.Handler {
	...
	r.HandleFunc("/updates/{id:[0-9]+}", c.UserWrapHandler(api.Update))
...
/**
 * @apiDefine Lists
 * @apiSuccess (200) {Object} pages				Page List
 * @apiSuccess (200) {String} pages.next	Next Page of List
 * @apiSuccess (200) {String} pages.prev	Previous Page of List
 * @apiSuccess (200) {String} pages.head	First Page of List
 * @apiSuccess (200) {String} pages.tail	Last Page of List
 * @apiSuccess (200) {Number} pages.total	Total Number of Pages of List
 */
...
func (a *APIv1) makeError(rw http.ResponseWriter, status int) {
	a.r.JSON(rw, status, map[string]string{
 ...
 * @apiError (403) Unauthorized The authentication token failed.
 */
 ...
 * @apiGroup Internals
 * @apiSuccess (200) {Number} version Version of the Server
 */
