...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # Enable provisioning with a shell script. Shell scripts are flexible,
  # and execute with sudo by default. See the vagrant documentation
  # online for more details, such as passing arguments or not running
  # with sudo.
